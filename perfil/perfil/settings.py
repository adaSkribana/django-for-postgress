...
SECRET_KEY = 'django-insecure-m*gq%x%o!peu$f@2%2rlf&grunjb1zn!i)od+0g@z_4xz!#&#8'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'first DB for Django',  # Reemplaza con el nombre de tu base de datos
        'USER': 'postgres',          # Reemplaza con tu nombre de usuario de PostgreSQL
        'PASSWORD': 'admin', # Reemplaza con tu contraseña de PostgreSQL
        'HOST': 'localhost',         # Reemplaza con la dirección de tu host si es necesario
